...
mount /persist
cp -f /persist/wlan/wlan_mac.bin /vendor/etc/wifi/peach_v2 2>/dev/null
cp -f /persist/wlan/wlan_mac.bin /vendor/etc/wifi/peach 2>/dev/null
umount /persist
mkdir -p /vendor/firmware/wlan/qca_cld/peach_v2
mkdir -p /vendor/firmware/wlan/qca_cld/peach
ln -sf /vendor/etc/wifi/peach_v2/wlan_mac.bin /vendor/firmware/wlan/qca_cld/peach_v2/wlan_mac.bin
ln -sf /vendor/etc/wifi/peach/wlan_mac.bin /vendor/firmware/wlan/qca_cld/peach/wlan_mac.bin
...
KO_FILES="cnss_prealloc.ko cnss_nl.ko wlan_firmware_service.ko cnss_plat_ipc_qmi_svc.ko cnss_utils.ko cnss2.ko gsim.ko rmnet_mem.ko ipam.ko rfkill.ko cfg80211.ko qca_cld3_peach.ko qca_cld3_peach_v2.ko smem-mailbox.ko"
